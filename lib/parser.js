...
export const setCommonFields = (schema, field) => {
...
export const parseBoolean = (schema, name = null) => {
  const field = {
    attrs: schema.attrs || {}
  }
...
export const parseString = (schema, name = null) => {
  const field = {
    attrs: schema.attrs || {}
  }
...
export const parseArray = (schema, name = null) => {
  const field = {
    attrs: schema.attrs || {}
  }
