...
| `validator`                   | `Function`                                    | The validator function to use to validate data before to emit the `input` event.<br>**Syntax**<br><code class="language-typescript">function validator(field: GenericField): Promise<boolean></code><br>**Parameters**<br><ul><li>**`field: GenericField`**The field that requests validation</li><li>**`field.id: string`**The input value for validation</li><li>**`field.name: string`**The input value for validation</li><li>**`field.value: any`**The input value for validation</li><li>**`field.schema: JsonSchema`**The input value for validation</li><li>**`field.required: boolean`**The input value for validation</li><li>**`field.hasChildren: boolean`**The input value for validation</li><li>**`field.initialValue: any`**The input value for validation</li><li>**`field.messages: Message[]`**The input value for validation</li></ul>**Return value**<br>A promise that return `true` if validation success and `false` otherwise<br> | `null`             |
