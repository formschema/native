...
describe('components/FieldsetElement', () => {
  it('should successfully render component', () => {
    ...
    const expected = '<fieldset id="id-character" name="character" aria-labelledby="id-character-label" aria-describedby="id-character-helper"><legend id="id-character-label" for="id-character">Character</legend><p id="id-character-helper">Your character</p><div data-fs-kind="radio" data-fs-field="character"><label id="character-goku-label" for="character-goku">Goku</label><div data-fs-wrapper="2"><div data-fs-input="radio"><input id="character-goku" type="radio" name="character" aria-labelledby="character-goku-label" aria-describedby="character-goku-helper" value="goku"></div><span id="character-goku-helper">Main Hero</span></div></div><div data-fs-kind="radio" data-fs-field="character"><label id="character-freezer-label" for="character-freezer">Freezer</label><div data-fs-wrapper="2"><div data-fs-input="radio"><input id="character-freezer" type="radio" name="character" aria-labelledby="character-freezer-label" aria-describedby="character-freezer-helper" value="freezer" checked="checked"></div><span id="character-freezer-helper">Main Monster</span></div></div></fieldset>';
