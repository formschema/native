...
describe('components/FieldsetElement', () => {
  it('should successfully render component', () => {
    ...
    const expected = '<fieldset id="id-character" name="character" aria-labelledby="id-character-label" aria-describedby="id-character-desc"><legend id="id-character-label" for="id-character">Character</legend><p id="id-character-desc">Your character</p><div data-fs-kind="radio" data-fs-field="character"><label id="character-goku-label" for="character-goku">Goku</label><div data-fs-input="radio"><input id="character-goku" type="radio" name="character" aria-labelledby="character-goku-label" aria-describedby="character-goku-desc" value="goku"><span id="character-goku-desc">Main Hero</span></div></div><div data-fs-kind="radio" data-fs-field="character"><label id="character-freezer-label" for="character-freezer">Freezer</label><div data-fs-input="radio"><input id="character-freezer" type="radio" name="character" aria-labelledby="character-freezer-label" aria-describedby="character-freezer-desc" value="freezer" checked="checked"><span id="character-freezer-desc">Main Monster</span></div></div></fieldset>';
