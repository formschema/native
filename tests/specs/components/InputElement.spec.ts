...
describe('components/InputElement', () => {
  it('should successfully render component', () => {
    ...
    const expected = '<div data-fs-kind="string" data-fs-field="name"><label id="id-name-label" for="id-name">Name</label><div data-fs-wrapper="2"><div data-fs-input="text"><input id="id-name" type="text" name="name" aria-labelledby="id-name-label" aria-describedby="id-name-helper" value="Goku" minlength="5" maxlength="15" pattern="arya|jon"></div><p id="id-name-helper">Your full name</p></div></div>';
