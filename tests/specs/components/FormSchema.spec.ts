...
describe('components/FormSchema', () => {
  ...
  describe('should successfully render component', () => {
    ...
    it('after the nextTick', () => {
      const wrapper = getWrapper({ schema });
      const expected = '<form id="id-form"><div data-fs-kind="string" data-fs-required="true"><label id="id-form-field-label" for="id-form-field">String</label><div data-fs-wrapper="2"><div data-fs-input="text"><input id="id-form-field" type="text" required="required" aria-required="true" aria-labelledby="id-form-field-label" aria-describedby="id-form-field-helper"></div><p id="id-form-field-helper">A String</p></div></div></form>';
    ...
    it('with a default slot', () => {
      ...
      const expected = '<form id="id-form"><div data-fs-kind="string" data-fs-required="true"><label id="id-form-field-label" for="id-form-field">String</label><div data-fs-wrapper="2"><div data-fs-input="text"><input id="id-form-field" type="text" required="required" aria-required="true" aria-labelledby="id-form-field-label" aria-describedby="id-form-field-helper"></div><p id="id-form-field-helper">A String</p></div></div>checking...</form>';
